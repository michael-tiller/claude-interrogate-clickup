---
description: Initial push of a taskout RC into ClickUp — Folder, List (or existing sprint), epic parents, and tasks
...
sidecar schemas, the 300-calls/24h budget discipline, bulk-tool preference,
